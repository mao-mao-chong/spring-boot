<template>
  <div>
    ...
    >
     <el-row>
                                                      <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="面试编号" prop="xuehao">
          <el-input v-model="ruleForm.xuehao" readonly              placeholder="面试编号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="面试者姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming"               placeholder="面试者姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="面试地点" prop="banji">
          <el-select v-model="ruleForm.banji" placeholder="请选择面试地点">
            <el-option
                ...
                :value="item">
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="面试官工号" prop="jiaoshigonghao">
          <el-input v-model="ruleForm.jiaoshigonghao" readonly              placeholder="面试官工号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="面试官姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"               placeholder="面试官姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item v-if="flag=='jiaoshi'" label="照片" prop="zhaopian">
          ...
          ></file-upload>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="所属部门" prop="zhicheng">
          <el-input v-model="ruleForm.zhicheng"               placeholder="所属部门" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="面试类型" prop="renjiaokecheng">
          <el-input v-model="ruleForm.renjiaokecheng"               placeholder="面试类型" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
