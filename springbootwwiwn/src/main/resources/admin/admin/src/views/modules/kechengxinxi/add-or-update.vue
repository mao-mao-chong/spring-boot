  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="专业方向" prop="kechengmingcheng">
              <el-input v-model="ruleForm.kechengmingcheng"
                placeholder="专业方向" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="专业类型" prop="kechengleixing">
          <el-select v-model="ruleForm.kechengleixing" placeholder="请选择专业类型">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.kechengleixing"
                placeholder="专业类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="个人专业" prop="banji">
          <el-select v-model="ruleForm.banji" placeholder="请选择个人专业">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.banji"
                placeholder="个人专业" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="面试人数" prop="xueqi">
          <el-select v-model="ruleForm.xueqi" placeholder="请选择面试人数">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingqi"
                placeholder="星期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="面试时间" prop="shangkeshijian">
          <el-select v-model="ruleForm.shangkeshijian" placeholder="请选择面试时间">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="面试时间" prop="shangkeshijian">
	      <el-input v-model="ruleForm.shangkeshijian"
                placeholder="面试时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="面试官工号" prop="jiaoshigonghao">
          <el-select  @change="jiaoshigonghaoChange" v-model="ruleForm.jiaoshigonghao" placeholder="请选择面试官工号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiaoshigonghao" label="面试官工号" prop="jiaoshigonghao">
  ...
  data() {
	...
	jiaoshixingming : false,
            ...
            ruleForm: {
                  ...
                  banji: [
                            { required: true, message: '个人专业不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xueqi: [
                            { required: true, message: '面试人数不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingqi: [
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.xueqiOptions = "上面试人数,下面试人数".split(',')
