  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">人才面试管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
																											<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">面试编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xuehao" class="input" type="text" placeholder="面试编号">
			   </div>
			 </div> -->
			<el-form-item label="面试编号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuehao" autocomplete="off" placeholder="面试编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
												...
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">面试者姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueshengxingming" class="input" type="text" placeholder="面试者姓名">
			   </div>
			 </div> -->
			<el-form-item label="面试者姓名" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xueshengxingming" autocomplete="off" placeholder="面试者姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			   ...
			   <div class="label">面试官工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshigonghao" class="input" type="text" placeholder="面试官工号">
			   </div>
			 </div> -->
			<el-form-item label="面试官工号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshigonghao" autocomplete="off" placeholder="面试官工号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshixingming" class="input" type="text" placeholder="面试官姓名">
			   </div>
			 </div> -->
			<el-form-item label="面试官姓名" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshixingming" autocomplete="off" placeholder="面试官姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<el-form-item label="所属部门" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.zhicheng" autocomplete="off" placeholder="所属部门" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<el-form-item label="面试类型" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.renjiaokecheng" autocomplete="off" placeholder="面试类型" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
