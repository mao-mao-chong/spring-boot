          ...
          <el-form-item class="input" label="专业方向" prop="kechengmingcheng">
              <el-input v-model="ruleForm.kechengmingcheng"
                placeholder="专业方向" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业类型" prop="kechengleixing">
          <el-input v-model="ruleForm.kechengleixing"
              placeholder="专业类型" clearable  :readonly="ro.kechengleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业类型" prop="kechengleixing">
              <el-input v-model="ruleForm.kechengleixing"
